...
class Graphics():
    ...
    def __init__(self, parent_scene):
       ...
       self.SCALEX = self.screen_rect.width / 255  # ratio screen pixels to galactic x, y (max 255 each)
       self.SCALEY = self.screen_rect.height / 255  # ratio screen pixels to galactic x, y (max 255 each)
       self.SCALE = self.screen_rect.height / 255  # ratio screen pixels to galactic x, y (max 255 each)
    ...
    def list_files(self, file_list):
       ...
       return list_dialog('Choose Planet Name', items=file_list)
