...
HUD_LEFT = Rect(BORDER, 4*BORDER,
                hud_l_w + BORDER, HUD_H + BORDER)

HUD_RIGHT = Rect(HUD_W - hud_r_w + BORDER, 4*BORDER,
                 hud_r_w + 2 * BORDER, HUD_H + BORDER)
HUD_CENTRE = Rect(hud_l_w + 2 * BORDER, BORDER,
...
SND_PULSE = "pulse"
SND_DOCK = "dock"
SND_INCOMMING_FIRE_1 = "incoming_fire_1"
SND_INCOMMING_FIRE_2 = "incoming_fire_2"
...
FLG_BOLD = 0x08
FLG_INACTIVE = 0x10
FLG_FLY_TO_PLANET = 0x20
FLG_FLY_TO_STATION = 0x40
FLG_HAS_ECM = 0x80
FLG_FIRING = 0x100
FLG_HOSTILE = 0x200
FLG_POLICE = 0x400
...
INITIAL_FLAGS = {
    ...
    SHIP_THARGOID:     FLG_BOLD | FLG_ANGRY,
    SHIP_THARGLET:     FLG_ANGRY,
