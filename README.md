...
31. Present the list of universe items as a list with distance and direction.
    ...
    If the target is a cargo canister or plate, the target location is 100m above the target to allow
    scooping without cancelling autopilot. 
...
44. Added new mission thargoid invasion in Galaxy 3. Kill 10 Thargoids gathered around station.
    ...
    If dormant thargoid is attacked it will wake up. This looks awesome!
...
Procedural planet imagery is perfomed by planet_generator.py
   This has mostly been generated by AI, producing a realistic planet image
   which is wrapped around a rotatinf sphere.
...
Pythonista-only structures are present in Elite.py, graphics.py, joystick.py.
hud_elite.py, image_helpers.py and small parts of wireframe_3d.py.
It is entirely possible to modify these modules to work with different graphics
on other systems.
