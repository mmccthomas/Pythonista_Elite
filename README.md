...
Scanner isnt big enough.
set HUD_H to larger value.
keep console same size since this doesnt need to be bigger
planet and sun clip needs to adjust correctly to size.
...
test combat.
allow pressing on universe list to instantly target object (could it track?)
...
check jump operation, temporaily remove mass lock
